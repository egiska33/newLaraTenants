...
Route::group(['middleware' => ['auth'], 'prefix'=> 'landlord' ], function (){
    ...
    Route::get('houses/landlord/{id}', 'Admin\UsersController@show')->name('show.landlord');
    ...
    Route::get('houses/{id}/documents/{document_id}', 'Landlord\DocumentsController@show')->name('view.landlord.document');
